...
final class NetworkModel {
   ...
   //  Function getTransformation: function that send for parameter a heroe, makes a call to the service and receive list of transformations if the hero has someone
